...
exports.shared_pages = {
  ...
  //        Valid options: Agouti, Cerulean, Cosmo, Cyborg, Darkly, Exor, Flatly, Journal, Litera, Lumen, Lux, Materia, Minty, Morph, Omega, Pulse, Quartz, Sandstone, Simplex, Sketchy, Slate, Solar, Spacelab, Superhero, United, Vapor, Yeti, Zephyr
...
exports.markets_page = {
  ...
  //            Supported exchanges: altmarkets, dex-trade, dexomy, freiexchange/freixlite, nonkyc, poloniex, qutrade, xeggex, yobit
  "exchanges": {
    ...
    // qutrade: a collection of settings that pertain to the qutrade exchange
    //          NOTE: qutrade does not display a 24-hour chart due to a lack of OHLCV api data
    "qutrade": {
      // enabled: Enable/disable the qutrade exchange (true/false)
      //          If set to false, the qutrade page will be completely inaccessible and no market data will be downloaded for this exchange
      "enabled": false,
      // trading_pairs: An array of market trading pair symbols
      //                You can add as many trading pairs as necessary
      //                All entries must specify your coins symbol as it is displayed on the exchange, followed by a slash (/) and ending with the symbol of the market or asset that is being traded against
